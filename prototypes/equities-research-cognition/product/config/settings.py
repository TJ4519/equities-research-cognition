...
MODEL_CHANGE_V0 = environ.get("FLYWHEEL_MODEL_CHANGE_V0", "0") == "1"
MODEL_CHANGE_CALC_BINARY = Path(
    environ.get("FLYWHEEL_MODEL_CHANGE_CALC_BINARY", which("soffice") or "")
)
MODEL_CHANGE_CALC_TIMEOUT_SECONDS = int(
    environ.get("FLYWHEEL_MODEL_CHANGE_CALC_TIMEOUT_SECONDS", "90")
)
MODEL_CHANGE_RUNTIME_POLL_LIMIT = int(
    environ.get("FLYWHEEL_MODEL_CHANGE_RUNTIME_POLL_LIMIT", "45")
)
MODEL_CHANGE_RUNTIME_READY_SECONDS = int(
    environ.get("FLYWHEEL_MODEL_CHANGE_RUNTIME_READY_SECONDS", "10")
)
